...
public class MainGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coinValue = sharedPreferences.getInt("coinValue", 0);
    ...
    public void updateQueAndOptions() {
       ...
       // buttonD.setText(currentQuestion.getOptD());
        ...
        if(HomeScreen.mGoogleApiClient.isConnected())
        Games.Leaderboards.submitScore(HomeScreen.mGoogleApiClient,
                getString(R.string.leaderboard_score),coinValue);
    }
